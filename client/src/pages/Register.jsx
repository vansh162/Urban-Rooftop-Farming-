...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-forest-green-50 to-white px-4 py-12">
      <motion.div
      ...
      >
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-forest-green-100 p-8">
          <h1 className="text-2xl font-bold text-forest-green-900 mb-6">Create account</h1>
          ...
          <p className="mt-4 text-center text-gray-600 text-sm">
            ...
            <Link to="/login" className="text-forest-green-600 font-medium hover:underline">
              Log in
            </Link>
          </p>
        </div>
